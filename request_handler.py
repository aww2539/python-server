...
from customers import get_all_customers, get_single_customer, get_customers_by_email, create_customer, delete_customer
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # Add a new object to the list. Don't worry about
